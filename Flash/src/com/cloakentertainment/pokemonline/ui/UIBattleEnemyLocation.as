package com.cloakentertainment.pokemonline.ui 
{
	 ...
	 * @author PROWNE
	 */
	public class UIBattleEnemyLocation extends UISprite
	{
		[Embed(source="assets/UIBattleEnemyLocation.png")]
		...
		public function UIBattleEnemyLocation(battleSpecialTile:String) 
		{
			super(spriteImage);
		...
		override public function construct():void
		{
			...
			bitmap =  getSprite(initX, initY, w, h);
