package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TBlueDoor extends Tile
	{
		[Embed(source="assets/TBlueDoor.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TBlueDoor.png")]
		...
		public function TBlueDoor(xTile:int, yTile:int) 
		{
			// create atlas
