package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TLightWater extends Tile
	{
		[Embed(source="assets/TLightWater.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TLightWater.png")]
		...
		public function TLightWater(xTile:int, yTile:int) 
		{
			// create atlas
			super(xTile, yTile, Tile.LIGHT_WATER, atlas.getTextures("water"), 5);
		}
