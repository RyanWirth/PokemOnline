package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TRockBottomLeft extends Tile
	{
		[Embed(source="assets/TRockBottomLeft.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TRockBottomLeft.png")]
		...
		public function TRockBottomLeft(xTile:int, yTile:int) 
		{
			// create atlas
