package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TRockTopRight extends Tile
	{
		[Embed(source="assets/TRockTopRight.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TRockTopRight.png")]
		...
		public function TRockTopRight(xTile:int, yTile:int) 
		{
			// create atlas
