package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TTelevision extends Tile
	{
		[Embed(source="assets/TTelevision.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TTelevision.png")]
		...
		public function TTelevision(xTile:int, yTile:int) 
		{
			// create atlas
			super(xTile, yTile, Tile.TELEVISION, atlas.getTextures("tile"), 6);
		}
