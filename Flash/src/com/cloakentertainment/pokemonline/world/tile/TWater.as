package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TWater extends Tile
	{
		[Embed(source="assets/TWater.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TWater.png")]
		...
		public function TWater(xTile:int, yTile:int) 
		{
			// create atlas
			super(xTile, yTile, Tile.WATER, atlas.getTextures("water"), 5);
		}
