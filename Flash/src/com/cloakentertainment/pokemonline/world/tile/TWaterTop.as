package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TWaterTop extends Tile
	{
		[Embed(source="assets/TWaterTop.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TWaterTop.png")]
		...
		public function TWaterTop(xTile:int, yTile:int) 
		{
			// create atlas
