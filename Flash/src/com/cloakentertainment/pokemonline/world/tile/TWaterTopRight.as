package com.cloakentertainment.pokemonline.world.tile 
{
	 ...
	 * @author ...
	 */
	public class TWaterTopRight extends Tile
	{
		[Embed(source="assets/TWaterTopRight.xml", mimeType="application/octet-stream")]
		public static const AtlasXml:Class;
		 
		// Embed the Atlas Texture:
		[Embed(source="assets/TWaterTopRight.png")]
		...
		public function TWaterTopRight(xTile:int, yTile:int) 
		{
			// create atlas
