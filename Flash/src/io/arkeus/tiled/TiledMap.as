package io.arkeus.tiled
{
	...
	public class TiledMap
	{
		...
		private function parseLayers(tmx:XML):void
		{
			...
			{
				var name:QName = new QName((elements[i] as XML).name());
		...
		{
			return ["Version: " + version, "Orientation: " + orientation, "Width: " + width, "Height: " + height, "TileWidth: " + tileWidth, "TileHeight: " + tileHeight, "BackgroundColor: " + backgroundColor, "Properties: " + properties, "Tilesets: " + tilesets, "Layers: " + layers,].join(", ");
		}
	}
}
